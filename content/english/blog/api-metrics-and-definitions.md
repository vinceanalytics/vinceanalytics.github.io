...
Automatically track the 404 error pages on your site. This feature isn't enabled by default so you need to [follow these steps](/blog/goals-404) to enable it for sites where you want to track 404 error pages.
...
Automatically track the number of file downloads. This feature isn't enabled by default so you need to [follow these steps](/blog/goals-file-downloads) to enable it for sites where you want to track clicks on files.
...
Automatically track the number of clicks on the external links. This feature isn't enabled by default so you need to [follow these steps](/blog/goals-outbound-links) to enable it for sites where you want to track clicks on external links.
...
To minimize the amount of traffic that falls within the "Direct / None" category, you can add special query parameters (UTMs) to your links. UTMs help you better understand where your traffic is coming from. Vince Analytics supports `utm_source`, `utm_medium`, `utm_campaign`, `utm_content` and `utm_term`.
